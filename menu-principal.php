...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
        <div class="container">
            <a class="navbar-brand" href="#">Ferretería Caramel</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    if ($rol == "admin") {
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="menu-usuario.php">usuarios</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="menu-articulo.php">articulos</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="menu-compra.php">compras</a>
                        </li>
                    <?php
                } else {
                    ?>
